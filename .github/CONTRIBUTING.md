...
├── configs/                    # Configuration files (Ghostty, themes, dircolors)
├── lib/
│   └── tasks/                  # Modular installation scripts (refactoring to installers/ planned)
├── documentation/              # Technical documentation (markdown source)
│   ├── architecture/
│   ├── setup/
│   ├── developer/
│   └── specifications/
├── astro-website/              # Astro website source
│   ├── src/                    # Markdown content for website
│   └── astro.config.mjs        # Build config (outDir: '../docs')
├── docs/                       # Astro build output (GitHub Pages)
│   └── .nojekyll               # CRITICAL - never remove
