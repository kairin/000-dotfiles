...
func ReadCodexConfig() (*CodexConfig, error) {
	...
	// nosemgrep: go.gosec.G304 -- path is fixed to ~/.codex/config.toml via codexConfigPath
	// nosemgrep: path-traversal -- path is fixed to ~/.codex/config.toml via codexConfigPath
