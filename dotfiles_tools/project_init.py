...
def init_project(
    ...
    *,
    ...
    try:
        ...
        return Report("init-project", "failed", str(repo_path), project=str(project_path), errors=[{"message": str(exc)}])
    ...
    try:
        ...
        if copilot and copilot_text is not None:
    ...
    entries = [{
        ...
        "source": str(repo_path / config.agent_template),
