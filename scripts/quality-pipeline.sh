...
echo "  All four Codacy checks are required by branch protection: 'codacy-safety-net'"
echo "  (this GitHub Actions workflow) plus the three Codacy app checks (Static Code"
echo "  Analysis, Coverage Variation, Diff Coverage). The app checks appear green on"
echo "  the PR once Codacy finishes processing the uploaded SARIF and coverage, and"
echo "  all four must report success before the merge can proceed."
